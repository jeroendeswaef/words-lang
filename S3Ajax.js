...
S3Ajax = {
	...
	// jdsw: added the charset, because FF3 adds the charset if the content type is just f.e. text/plain
	// and the content type has to correspond exactly
    ...
    httpClient: function(kwArgs) {
        ...
        */
        ...
        if (kwArgs['anonymous'] != true && this.KEY_ID && this.SECRET_KEY) {
            ...
            s += meta_to_sign;
            s += kwArgs.resource;
			console.log("auth before signing: ", s);
